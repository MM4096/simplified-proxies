	...
	return (<>
		...
		<dialog className="modal" ref={dialogRef}>
			<div className="modal-box flex flex-col gap-2">
				...
				<p><b>Simplified Proxies</b> is created by <b>mm4096</b><br/>All uncredited content is under the copyright of mm4096.</p>
				...
				<div className="collapse bg-base-100 border-base-300 border">
					...
					<div className="collapse-content">
						Colored Energy symbols (except &quot;<i>Free</i>&quot;) are created by <b>Biochao</b> via <Link href="https://www.deviantart.com/biochao/art/Pokemon-Trading-Card-Game-Energy-Symbols-906732898" className="link">devianart</Link>
						<br/><br/>
						The black and white Energy symbols are colored Energy symbols modified by mm4096.
						The &quot;<i>Free</i>&quot; (<Image src="/images/ptcg/icons/standard/n.png" width={32} height={32} alt="{n}" className="symbol"/>) Energy symbol is created by mm4096.
						<br/><br/>
						The &quot;Import Cards&quot; feature uses the Pokemon TCG API. (<Link href="https://pokemontcg.io/" className="link">pokemontcg.io/</Link>).
						<br/><br/>
						<small>Pokemon TCG API, The Pokemon Company and Nintendo do not produce or endorse Simplified Proxies in any
							way.</small>
					</div>
				</div>
