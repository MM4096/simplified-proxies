	...
	return (<>
		<div className="index">
			...
			<div className="flex flex-col items-center justify-center gap-4 mtg-panel carousel">
				<Carousel time={3000}
						  standardPaths={{
							  ...
							  paths: ["three-visits", "urza-s-saga", "commit", "jared-carthalion", "virtue-of-persistence"],
							  suffix: ".jpg",
						  }} className="w-1/3"/>
			...
			<div className="flex flex-col items-center justify-center gap-4 ptcg-panel carousel">
				...
				<CardCarousel jsonPath="public/data/index/ptcg-carousel.json" time={3000} gameId="ptcg" className="w-1/3"/>
			</div>
